...
const bareMetal = "C:/webass/emsdk_env.bat & echo Building... & emcc -o ./public/appWASM.js ./src/webass/cpp/emscripten.cpp -O3 -s ASSERTIONS=1 -s TOTAL_MEMORY=256MB -s ALLOW_MEMORY_GROWTH=1 -s WASM=1 -s NO_EXIT_RUNTIME=1 -std=c++1z && python C:/heroes/correctPath.py"
