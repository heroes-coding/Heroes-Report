...
const toHTML = "C:/webass/emsdk_env.bat & echo Building... & emcc -o ./public/wasm.html ./src/webass/cpp/emscripten.cpp -O3 -s ALLOW_MEMORY_GROWTH=1 -s WASM=1 -s NO_EXIT_RUNTIME=1 -std=c++1z"
